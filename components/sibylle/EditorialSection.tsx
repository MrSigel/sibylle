  ...
  return (
    <section className="section-shell overflow-hidden">
      ...
      <div className="container relative grid gap-12 lg:grid-cols-[.55fr_1fr] lg:gap-20">
        <motion.div initial={{opacity:0,y:25}} whileInView={{opacity:1,y:0}} viewport={{once:true}} className="lg:pt-4">
          <p className="eyebrow">Systemisches Coaching</p>
          <p className="mt-7 max-w-sm text-sm leading-7 text-gold">
            Nicht alles, was sich festgefahren anfühlt, braucht mehr Anstrengung. Manches braucht einen geschützten Blick auf das, was im System wirkt.
          </p>
        </motion.div>
        <motion.div initial={{opacity:0,y:35}} whileInView={{opacity:1,y:0}} viewport={{once:true,amount:.25}} transition={{duration:.9}}>
          <h2 className="editorial text-[clamp(2.8rem,5.6vw,6rem)] leading-[.98]">
            Systemische Aufstellung macht <span className="italic text-deepGold">Beziehungsmuster</span> sichtbar, ohne sie zu bewerten.
          </h2>
          <div className="mt-10 grid gap-7 border-t border-gold/20 pt-8 md:grid-cols-2">
