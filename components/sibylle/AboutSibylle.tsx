      ...
      <div className="container grid items-center gap-14 lg:grid-cols-[.9fr_1.1fr] lg:gap-24">
        <div className="relative mx-auto w-full max-w-[500px]">
          <motion.div 
            ...
            className="relative aspect-[4/5] overflow-hidden rounded-[3.5rem] bg-sibylleMist shadow-[0_35px_90px_rgba(35,42,26,.14)]"
          >
            <Image 
          ...
          <motion.div 
            ...
            className="absolute -bottom-8 -right-8 z-20 flex h-28 w-28 items-center justify-center rounded-full bg-deepOlive shadow-2xl md:h-36 md:w-36"
          >
        ...
        <motion.div initial={{opacity:0,x:35}} whileInView={{opacity:1,x:0}} viewport={{once:true}} transition={{duration:1,ease:[0.22, 1, 0.36, 1]}}>
          ...
          <blockquote className="editorial my-10 border-l-4 border-softGold pl-8 text-3xl italic leading-snug text-deepOlive/90">
            „Muster lassen sich sehen, ohne sie zu bewerten.“
          </blockquote>
          <p className="max-w-xl text-lg leading-9 text-deepOlive/80">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
             <div className="inline-flex items-center gap-4 rounded-full border border-olive/20 bg-white/55 px-6 py-4 text-xs font-bold uppercase tracking-[.14em] text-deepOlive shadow-sm">
