...
const categories = [
  { name: "Verträge", count: 0, icon: "folder" },
  { name: "Rechnungen", count: 0, icon: "folder" },
  { name: "Klienten-Notizen", count: 0, icon: "folder" },
  { name: "DSGVO / Rechtliches", count: 0, icon: "folder" },
  { name: "Vorlagen", count: 0, icon: "folder" },
];
