...
export const metadata = pageMetadata({
  ...
  description:
    "Die Academy von Sibylle Jutta Bergold: Aufzeichnungen, Selbst-Aufstellungs-Übungen und monatliche Live-Gruppensessions rund um systemische Aufstellungen und Selbsterfahrung.",
  path: "/academy",
