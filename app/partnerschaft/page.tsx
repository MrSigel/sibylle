...
export default function PartnerschaftPage() {
  ...
  return (
    <main className="overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          ...
          >
            ...
            <h1 className="editorial mt-7 text-[clamp(3.2rem,7vw,7.5rem)] leading-[.88] text-warmBlack">
              Wenn Beziehung sich <span className="italic text-deepOlive">schwerer</span> anfühlt, als sie sollte.
            </h1>
            ...
            <div className="mt-10 rounded-[2rem] bg-white/40 backdrop-blur-sm border border-olive/10 p-8 text-base leading-8 text-deepOlive/80">
        ...
        <div className="container">
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <h3 className="mt-6 font-serif text-2xl italic text-deepOlive/70">Wenn Nähe und Abstand sich ständig abwechseln</h3>
              <div className="mt-8 space-y-6 text-base leading-8 text-deepOlive/85">
                ...
                <div className="rounded-2xl border-l-4 border-softGold bg-sibylleMist/20 p-6 italic text-deepOlive/80">
            ...
            <div className="relative aspect-square lg:aspect-[4/5]">
               <motion.div 
                 ...
                 viewport={{ once: true }}
                 className="relative h-full w-full overflow-hidden rounded-[3.5rem] border border-olive/10 shadow-2xl"
               >
        ...
        <div className="container">
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <h3 className="mt-6 font-serif text-2xl italic text-deepOlive/70">Warum ziehe ich immer wieder ähnliche Menschen an?</h3>
              <div className="mt-8 space-y-6 text-base leading-8 text-deepOlive/85">
                <p>
                ...
                <p className="font-semibold text-deepOlive/90">Nicht um dich zu bewerten. Sondern um zu verstehen, warum sich etwas wiederholt.</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="section-shell overflow-hidden">
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
             ...
             <h3 className="mt-6 font-serif text-2xl italic text-deepOlive/70">Wenn eine Trennung mehr berührt als das Ende einer Beziehung</h3>
          </div>
          ...
          <div className="mt-16 flex flex-col items-center">
            ...
            >
              <div className="space-y-8 text-lg leading-9 text-deepOlive/80">
                <p>
      ...
      {/* Final CTA */}
      <section className="section-shell bg-warmBlack py-28 text-center text-cream">
        <div className="container max-w-3xl">
          <h2 className="editorial text-4xl md:text-5xl lg:text-7xl">Klarheit für dein Herz.</h2>
          <p className="mt-10 text-xl leading-relaxed text-cream/70">
          ...
          <div className="mt-14 flex flex-col justify-center gap-5 sm:flex-row">
            <CTAButton href={waLink} className="bg-cream !text-warmBlack hover:bg-softGold">
              Anfrage senden
            </CTAButton>
