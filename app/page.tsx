...
export const metadata = pageMetadata({
  ...
  description: "Systemische Aufstellung, Coaching und Termine für eine erste Session mit Sibylle Jutta Bergold. Beziehungsmuster und Familienmuster online oder in Aschaffenburg klären.",
  path: "/",
